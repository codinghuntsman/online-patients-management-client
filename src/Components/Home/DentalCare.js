        ...
        <section>
            <div className="card lg:card-side bg-base-100 shadow-xl mt-36 px-10 flex justify-center items-center">
                ...
                <div className="card-body flex-1">
                    ...
                    <p className=' font-serif text-md text-black text-justify'> Dental or oral health is concerned with your teeth, gums and mouth. The goal is to prevent complications such as tooth decay, and gum disease and to maintain the overall health of your mouth. Why do we need dental care? Image result for dental care. Maintaining your teeth isn't only about looking good. Poor dental hygiene can lead to problems that are much bigger than an unpleasant smile.
                        Tooth decay and gum disease can affect other parts of your body, including your heart.</p>
