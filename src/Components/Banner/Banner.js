        ...
        <section style={{ background: `url(${Bg})`, backgroundSize: "cover" }} >
            <div className="hero min-h-screen">
                <div className="hero-content flex-col lg:flex-row-reverse md:flex-row-reverse w-full">
                    ...
                    <div>
                        <h1 className="text-xl lg:text-5xl font-bold font-sans bg-clip-text">Your New Smile Starts Here</h1>
                        <p className="py-4 w-72 lg:w-full font-bold font-sans text-justify text-sm lg:text-[16px] bg-clip-text">What is the best treatment for teeth?
